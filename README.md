...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-night-9e0c
```

A live public deployment of this template is available at [https://crimson-night-9e0c.templates.workers.dev](https://crimson-night-9e0c.templates.workers.dev)
